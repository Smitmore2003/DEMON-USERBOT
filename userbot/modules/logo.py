...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        async for i in event.client.iter_messages(
            "@demon_ub_support", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
...
CMD_HELP.update({"logo": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.logo <text>`"
                 "\n↳ : Generate logo from given Text or Reply To image, to write your text on it. Or Reply To Font File, To write with that font."})
